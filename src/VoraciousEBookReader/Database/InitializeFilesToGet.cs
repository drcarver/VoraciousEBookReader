...
namespace SimpleEPUBReader.Database
{
    ...
    class InitializeFilesToGet
    {
        ...
        public static bool GetMustCopyInitialDatabase()
        {
            ...
            var task = destinationFolder.FileExistsAsync(BooksContext.BooksDatabaseFilename);
            task.Wait();
        ...
        public static async Task CopyAssetDatabaseIfNeededAsync(UwpRangeConverter progressBar)
        {
            ...
            //var bookdbfullpath = destinationFolder + @"\" + BooksContext.BooksDatabaseFilename;
            var exists = await destinationFolderFolder.CheckExistsAsync(BooksContext.BooksDatabaseFilename);

            var existingFile = await FolderMethods.GetFileAsync(destinationFolderFolder, BooksContext.BooksDatabaseFilename);
            ...
            if (exists != ExistenceCheckResult.FileExists && copyFileAsNeeded)
            {
                ...
                var initialFullPath = FolderMethods.InstallationFolder + @"\" + @"Assets\InitialBooks.Zip";
                ...
                // Can't just copy the file: await originalInstalledFile.CopyAsync(destinationFolder, BooksContext.BooksDatabaseFilename);
        ...
        public async Task CreateDatabaseAsync(BooksContext bookdb)
        {
        ...
        public async Task<int> DownloadBooksAsync(BooksContext bookdb)
        {
            int n = 0;
            ...
            IQueryable<Books> includeList = bookdb.Books
                .Include(b => b.People)
                .Include(b => b.Files)
                .AsQueryable();
