...
{
    /// <summary>
    /// Display a BookCard using a Books object
    /// </summary>
    public sealed partial class BookCard : UserControl
    {
        ...
        private async Task DownloadBookAsync(BooksContext bookdb, Books book, FilenameAndFormatData file)
        {
            Uri uri;
        ...
        private void OnReadNow(object sender, RoutedEventArgs e)
        {
            ...
            nav.DisplayBook(parentControlId, DataContext as Books);
        }
    }
}
