        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BooksBookId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilenameAndFormatData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FilenameAndFormatData_Books_BooksBookId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Person_Books_BooksBookId",
                        column: x => x.BooksBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilenameAndFormatData_BooksBookId",
                table: "FilenameAndFormatData",
                column: "BooksBookId");

            migrationBuilder.CreateIndex(
                name: "IX_Person_BooksBookId",
                table: "Person",
                column: "BooksBookId");
